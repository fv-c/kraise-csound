...
<Cabbage> bounds(0, 0, 0, 0)
    form caption("Kraise - 1st Order Ambisonics") size(850, 450), pluginId("vii1"), colour("40,40,40,255")
    ;TITOLO
    label bounds(10, 10, 551, 30) channel("label10021") text("Kraise - 1st Order Ambisonics")
